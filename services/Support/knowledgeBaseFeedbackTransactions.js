...
exports.get = (req, res) => {
    ...
    try {
        mm.executeQueryData(
            setContext + 'CALL sp_knowledgeBaseFeedbackTransactions_get()',
            [],
            supportKey,
            (error, results) => {
                if (error) {
...
exports.create = (req, res) => {
    ...
    try {
        const query = `CALL sp_knowledgeBaseFeedbackTransactions_create(?,?,?,?,?,?)`;
        const params = [
            data.USER_ID,
            data.KNOWLEDGE_MASTER_ID,
            data.IS_HELPFUL,
            data.REMARK,
...
exports.update = (req, res) => {
    ...
    try {
        const query = `CALL sp_knowledgeBaseFeedbackTransactions_update(?,?,?,?,?,?,?,?)`;
        const params = [
            req.body.ID,
            data.USER_ID,
            data.KNOWLEDGE_MASTER_ID,
