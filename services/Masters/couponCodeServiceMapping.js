...
exports.get = (req, res) => {
   const supportKey = req.headers['supportkey'];
    ...
    try {
        ...
        mm.executeQueryData(
            setContext+'CALL sp_couponCodeServiceMapping_get()',
            [],
            supportKey,
            (error, results) => {
                if (error) {
...
exports.create = (req, res) => {
    ...
    mm.executeQueryData(
        `CALL sp_couponCodeCountryService_create(?,?,?,?,?,?,?,?)`,
        [
            d.COUPON_ID,
            d.SERVICE_ID,
            d.COUNTRY_ID,
...
exports.update = (req, res) => {
    ...
    mm.executeQueryData(
        `CALL sp_couponCodeCountryService_update(?,?,?,?,?,?,?,?,?)`,
        [
            req.body.ID,
            d.COUPON_ID,
            d.SERVICE_ID,
